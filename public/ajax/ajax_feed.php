...
if ($action=="dns") {
	...
	echo "<div id=\"busy\"><div style=\"float:left;\"><img src=\"images/ship_load_ing.gif\" alt=\"tenships\" width=\"135\" height=\"97\" /></div></div>";
        // Reverse DNS
        include("Net/DNS.php");
...
//print_r($response);
//echo "</pre>";
	echo "<br /><table cellpadding=\"0\" cellspacing=\"0\" align=\"center\"><tr><td class=\"tl\"></td><td class=\"top\"></td><td class=\"tr\"></td></tr><tr><td class=\"left\"></td><td class=\"nav\"><div id=\"floatinginfo\"><div id=\"floatinginside\" align=\"center\"><pre><a href=\"javascript:whois();\">".$domain."</a>&nbsp;&nbsp;-&nbsp;<a href=\"javascript:ipwhois();\">".$ip[0].".".$ip[1].".".$ip[2].".".$ip[3]."</a>&nbsp;<br/><b>Reverse DNS:</b>";
        if ($response) {
